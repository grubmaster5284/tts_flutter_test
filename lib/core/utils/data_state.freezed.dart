...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$DataStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$SuccessImpl<T> implements _Success<T> {
  const _$SuccessImpl({required this.value});
...
abstract class _Success<T> implements DataState<T> {
  const factory _Success({required final T value}) = _$SuccessImpl<T>;
...
class __$$FailureImplCopyWithImpl<T, $Res>
  ...
  $Res call({Object? error = null}) {
    return _then(_$FailureImpl<T>(null == error ? _value.error : error));
  }
}
...
abstract class _Failure<T> implements DataState<T> {
  const factory _Failure(final Object error) = _$FailureImpl<T>;
